-- 閉店時に「受付を止めた日」も消す（2026-09-01）
--
-- booking_closed_days を足した（20260901000000）ので、delete_my_gym の消し込み対象に加える。
--
-- 🔴 定義は 20260831010500_delete_gym_videos.sql の**最新の版から機械的に写し**、
--    booking_closed_days の1行だけを足してある。古い版から書き直すと、その間に増えた
