...
// 以前は特定ジム名（Salute御所南）だったが、どのジムのお客様にもそのまま見えてしまうため
// 製品名（ジムボード / GymBoard）に統一している。ジム名は各ツールが返すデータ側に出る。
export default defineMcp({
  name: "gymboard-mcp",
  title: "ジムボード MCP",
  version: "0.1.0",
  instructions:
    "Tools for the GymBoard gym-management app. Use `get_profile` to read the signed-in customer's profile, `list_upcoming_bookings` for upcoming reservations, and `list_recent_measurements` for recent body measurements.",
