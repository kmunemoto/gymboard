      ...
      */}
      ...
      <section>
        ...
        {bookingsLoading ? (
          ...
          const cycleWindow = profile?.cycle_start_date ? getCycleWindow(profile.cycle_start_date, now, resolveCycleMonths(profile?.plan, tenantPlans), resolveCycleUnit(profile?.plan, tenantPlans)) : null;
