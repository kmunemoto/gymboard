...
const scenarios: Scenario[] = [
  ...
  // 🔴 月末起算（2026-08-22 修正）: Deno 移植の addMonthsEpoch が月末をクランプせず
  // （1/31+1ヶ月 → 3/3）、月末起算のお客様だけ期限リマインドの窓がずれていた。
  // クライアント（date-fns）・DB（Postgres interval）と同じクランプ（→ 2/28）に修正。
  // 窓の開始・終了そのものが一致することを最終利用日の突き合わせで固定する。
  { name: "月末起算 1/31（2月へクランプ）", start: "2026-01-31", max: 8, pinned: true, dates: ["2026-02-05"], now: "2026-02-20" },
  { name: "月末起算 1/31・数サイクル後（累積ずれ無し・未固定でも同じ）", start: "2026-01-31", max: 8, dates: [], now: "2026-09-15" },
  { name: "月末起算 8/31（9/30 へクランプ）", start: "2026-08-31", max: 4, pinned: true, dates: ["2026-09-05"], now: "2026-09-20" },
  { name: "月末起算・閏年 2024-01-31", start: "2024-01-31", max: 8, dates: [], now: "2024-02-20" },
  // 🔴 期間を1回目の日に引き直したら、回数もその期間で数える（2026-09-24。本番の実データの日付）
  { name: "起算日より後に1回目（引き直した期間で数える）", start: "2026-09-17", max: 4, dates: ["2026-10-03", "2026-10-10", "2026-10-24"], now: "2026-09-24" },
  { name: "古い起算日・引き直した期間に4件（使い切り）", start: "2026-06-06", max: 4, graceDays: 7, dates: ["2026-06-06","2026-06-13","2026-06-21","2026-06-28","2026-07-12","2026-07-15","2026-07-18","2026-07-26","2026-08-01","2026-08-10","2026-08-16","2026-08-26","2026-09-05","2026-09-12","2026-09-26","2026-10-03","2026-10-11","2026-10-24"], now: "2026-09-24" },
];
